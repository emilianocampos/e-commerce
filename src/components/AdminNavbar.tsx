  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-zinc-200 bg-white shadow-sm">
      <div className="flex h-16 items-center justify-between px-6">
        <Link href="/admin" className="text-xl font-black tracking-tight text-zinc-900">
          SHOP.CO <span className="text-sm font-normal text-zinc-500 ml-2">Admin Panel</span>
        </Link>
